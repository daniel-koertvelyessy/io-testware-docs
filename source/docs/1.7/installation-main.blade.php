...
@section('content')
    ...
    <p>testWare basiert auf dem php Framework <a href="https://laravel.com/" target="_blank">laravel</a>. Daher ist ein System notwendig, welches php Befehle / Dateien lesen und ausführen kann. Gegenwärtig sind zwei Arten verfügbar, mit der eine testWare Instanz initialisiert werden kann:</p>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <x-overview-item header="Terminal" link="/docs/1.7/installation-terminal">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <x-overview-item header="Browser" link="/docs/1.7/installation-browser">
