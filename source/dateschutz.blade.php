...
@section('body')
    ...
    <div class="mt-3 font-light">
        <p>Wir freuen uns über Ihr Interesse an unserer Firma und unserem Onlineangebot. Der Schutz Ihrer Privatsphäre ist für uns sehr wichtig. Nachstehend informieren wir Sie ausführlich über den Umgang mit Ihren Daten.</p>
        <h3>Allgemeines</h3>
        <p>Diese Datenschutzerklärung bezieht sich nur auf unsere Webseiten:</p>
        <ul class="list-none">
            <li>
                <span class="font-bold">www.thermo-control.com</span> <br>
                <span class="text-sm ml-5">inklusive aller sogenannten Sub-Domains shop.thermo-control.com oder portal.thermo-control.com</span>
            </li>
        ...
        <div>
            ...
            <h5><span class="font-bold">Hostingdienstleistungen durch einen Drittanbieter</span></h5>
        ...
        <div>
            <h4>
                <span class="font-bold">2. Datenerhebung und -verwendung zur Vertragsabwicklung und bei Eröffnung eines Kundenkontos</span>
            </h4>
        ...
        <div>
            <h4><span class="font-bold">3. Datenweitergabe</span></h4>
        ...
        <div>
            <h4><span class="font-bold">4. E-Mail-Newsletter</span></h4>
            <h5><span class="font-bold">E-Mail-Werbung mit Anmeldung zum Newsletter</span></h5>
        ...
        <div>
            <h4><span class="font-bold">5. Integration des Trusted Shops Trustbadge (explizit für shop.thermo-control.com und thermo-control.shop)</span></h4>
        ...
        <div id="cookieless">
            ...
            <h5><span class="font-bold">Einsatz von Google (Universal) Analytics zur Webanalyse</span></h5>
            ...
            <p>Die Google LLC hat ihren Hauptsitz in den USA und ist zertifiziert unter dem EU-US-Privacy Shield. Ein aktuelles Zertifikat kann
            ...
            <p>Sie können Ihre Einwilligung jederzeit mit Wirkung für die Zukunft widerrufen, indem sie das unter dem folgenden Link verfügbare Browser-Plugin herunterladen und installieren:
            ...
            <p>Alternativ zum Browser-Plugin können Sie
                <a>diesen Link</a>
               klicken, um die Erfassung durch Google Analytics auf dieser Website zukünftig zu verhindern. Dabei wird ein Opt-Out-Cookie auf Ihrem Endgerät abgelegt. Löschen Sie Ihre Cookies, werden Sie erneut um Erteilung Ihrer Einwilligung gebeten.
            </p>

        </div>
        <div>
            <h4><span class="font-bold">7. Kontaktmöglichkeiten und Ihre Rechte</span></h4>
